...
listofplots <- list(plot_rbd_35, plot_rbd_janmay, plot_rbd_proj, plot_rbd_sepdec,
                    plot_rbd_janmay_fac, plot_rbd_proj_fac,  plot_rbd_sepdec_fac,
                    plot_sahel_janmay, plot_sahel_proj,   plot_sahel_sepdec, 
                    plot_coastal_janmay, plot_coastal_proj,  plot_coastal_sepdec, 
                    plot_sahel_janmay_perc, plot_sahel_proj_perc,  plot_sahel_sepdec_perc, 
                    plot_coastal_janmay_perc, plot_coastal_proj_perc,  plot_coastal_sepdec_perc,
                    plot_sahel_phase_janmay, plot_sahel_phase_proj,  plot_sahel_phase_sepdec,
                    plot_coastal_phase_janmay, plot_coastal_phase_proj, plot_coastal_phase_sepdec)
